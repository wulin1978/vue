...
/* eslint-disable spaced-comment */
  export default {
    ...
    mounted: function () {
      this.$options.methods.mylist.bind(this)(this.list, document.getElementsByClassName('mylist0')[0])
    }
  }
</script>
<style lang='scss'>
